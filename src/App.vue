<script setup>
  ...
  import {calcultarTotalPagar} from './helpers'
  ...
  watch([cantidad,meses], () =>{
    total.value= calcultarTotalPagar(cantidad.value, meses.value)
  })
...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div class="my-5">
      ...
      <select
       class="w-full p-2 bg-white border boder-gray-300 rounded-lg text-center text-xl fonto-bold text-gray-500 mt-5"
       name="" 
       id=""
       :value="meses"
